...
<div class="announcement-box">
  <p class="announcement-box__lede">TREC RAG is returning for 2026! 🥳</p>
  ...
  <ul>
    ...
    <li>Join our <a href="https://groups.google.com/g/trec-rag-2026-participants">Google Groups mailing list</a> and <a href="https://discord.gg/m6qMuhuux">Discord</a>! For Google Groups, please include "TREC RAG" in your request to join. Contact njedidi@uwaterloo.ca if you have any issues joining.</li>
  </ul>
  <p><strong>More coming! Stay tuned. </strong></p>
  <p class="announcement-box__signature">Best regards,<br>TREC RAG Organizers</p>
</div>
